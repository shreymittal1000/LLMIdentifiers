...
class Prompter:
    ...
    def conclusion_prompt(self) -> str:
        ...
        self._memory.append({
            "role": "system",
            "content": (
                "Based on this conversation, please now conclude which model the other agent is. Explain your reasoning. You only need to guess the model family, which is one of. Your answer should be in the following format:\n"
                "1. <reasoning>\n"
                "2. <model_family>\n"
